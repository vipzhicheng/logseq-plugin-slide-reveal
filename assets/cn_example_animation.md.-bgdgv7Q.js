import{_ as a,c as t,o as s,a5 as n}from"./chunks/framework.DwbewbAn.js";const m=JSON.parse('{"title":"动画","description":"","frontmatter":{},"headers":[],"relativePath":"cn/example/animation.md","filePath":"cn/example/animation.md"}'),p={name:"cn/example/animation.md"},e=n(`<h1 id="动画" tabindex="-1">动画 <a class="header-anchor" href="#动画" aria-label="Permalink to &quot;动画&quot;">​</a></h1><h2 id="简单的动画" tabindex="-1">简单的动画 <a class="header-anchor" href="#简单的动画" aria-label="Permalink to &quot;简单的动画&quot;">​</a></h2><p>如果没有 <code>data-id</code>，则使用内容来识别进行动画。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>- ## Auto Animation</span></span>
