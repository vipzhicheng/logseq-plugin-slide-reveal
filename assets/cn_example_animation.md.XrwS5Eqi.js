import{_ as t,c as s,o as n,ag as p}from"./chunks/framework.3H72gWKR.js";const r=JSON.parse('{"title":"动画","description":"","frontmatter":{},"headers":[],"relativePath":"cn/example/animation.md","filePath":"cn/example/animation.md"}'),e={name:"cn/example/animation.md"};function i(l,a,o,d,c,u){return n(),s("div",null,a[0]||(a[0]=[p(`<h1 id="动画" tabindex="-1">动画 <a class="header-anchor" href="#动画" aria-label="Permalink to &quot;动画&quot;">​</a></h1><h2 id="简单的动画" tabindex="-1">简单的动画 <a class="header-anchor" href="#简单的动画" aria-label="Permalink to &quot;简单的动画&quot;">​</a></h2><p>如果没有 <code>data-id</code>，则使用内容来识别进行动画。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- ## Auto Animation</span></span>
...
<span class="line"><span>	- ## A</span></span>
<span class="line"><span>	- ## C</span></span></code></pre></div><h2 id="基于-data-id-的动画" tabindex="-1">基于 <code>data-id</code> 的动画 <a class="header-anchor" href="#基于-data-id-的动画" aria-label="Permalink to &quot;基于 \`data-id\` 的动画&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- Another Animation</span></span>
<span class="line"><span>  data-theme:: white</span></span>
<span class="line"><span>  data-auto-animate:: true</span></span>
...
<span class="line"><span>	  					&lt;/div&gt;</span></span></code></pre></div><h2 id="局部放大" tabindex="-1">局部放大 <a class="header-anchor" href="#局部放大" aria-label="Permalink to &quot;局部放大&quot;">​</a></h2><p>按住 <code>alt</code> 键，鼠标单击，可以放大局部。</p>`,11)]))}const g=t(e,[["render",i]]);export{r as __pageData,g as default};
